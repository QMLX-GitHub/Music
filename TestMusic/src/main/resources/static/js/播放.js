...
class MusicPlayer {
    ...
    constructor(
        data = {
            // 歌曲信息在这里修改
            songObjArr: [
                {url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},
                {url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},
                {url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},
                {url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},
                {url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},{url: "", title: "",author:"",imgSrc: "",},
        ...
        {
            var x=responseData[i];
            data.songObjArr[i].url = x.url;
            data.songObjArr[i].title = x.songname;
            data.songObjArr[i].author =x.name;
            data.songObjArr[i].imgSrc=x.image;
        }

//        data.songObjArr[values[4]].url = values[0];
//        data.songObjArr[values[4]].title = values[1];
//        data.songObjArr[values[4]].author = values[2];
//        data.songObjArr[values[4]].imgSrc=values[3];
//        data.songObjArr[1].url = values[0];
//        data.songObjArr[1].title = "values[1]";
//        data.songObjArr[1].author = values[2];
//        data.songObjArr[1].imgSrc=values[3];
        // 与 _renderFrame 相关变量
