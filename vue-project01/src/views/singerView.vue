    ...
    <div>
        ...
        <el-container style="height: 800px; border: 10px solid #eee">
            ...
            <el-main>
                ...
                <el-button type="primary" @click="showDialog">添加歌手</el-button>
                <el-dialog :visible.sync="dialogVisible" title="表单">
                    <el-form ref="userForm" :model="singer" label-width="70px">
                        ...
                        <el-form-item label="图片链接">
                            <el-input type="textarea" :rows="4" placeholder="请输入图片链接" v-model="singer.image">
                            </el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="详细介绍">
                            <el-input type="textarea" :rows="4" placeholder="请输入详细介绍" v-model="singer.introduction">
                            </el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-button type="primary" @click="addSinger">提交</el-button>
                ...
                <el-form :inline="true" :model="singer" class="demo-form-inline">
                    <el-form-item label="姓名">
                        <el-input v-model="singer.name" placeholder="姓名"></el-input>
                    </el-form-item>
                    <el-form-item label="性别">
                        <el-select v-model="singer.sex" placeholder="性别">
                            <el-option label="男" value="男"></el-option>
                            <el-option label="女" value="女"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="作品">
                        <el-input v-model="singer.location" placeholder="作品"></el-input>
                    </el-form-item>
                    <el-form-item>
                ...
                <el-table :data="tableData" stripe border @selection-change="handleSelectionChange">
                    ...
                    <el-table-column prop="location" label="代表作" width="150" align="center"> </el-table-column>
                    <el-table-column prop="introduction" label="简介" width="250" align="center"></el-table-column>
...
export default {
    ...
    async mounted() {
        ...
        //发送异步请求,获取数据
        /*  axios.get("http://192.168.44.1:8080/loginRequest").then((result) => {
             console.log(result);
    ...
    methods: {
        ...
        //添加歌手
        addSinger() {
            axios.post('http://localhost:8080/saveSinger', this.singer)
                .then(response => {
                    // 处理成功保存用户信息的逻辑
        ...
        onSubmit() {
            axios.post("http://localhost:8080/selectByPageAndCondition",this.singer).then((result) => {
                console.log(result);
                this.totalcount = result.data.data.totalCount;
                this.tableData = result.data.data.rows;
            });
        ...
        deleteByIDs() {
            ...
            //发送ajax请求
            axios.post('http://localhost:8080/deleteByIds', this.selectionIds)
                .then(response => {
                    // 处理成功保存用户信息的逻辑
                    console.log(response);
        ...
        selectSingers() {
            axios.get("http://localhost:8080/SelectByPage", {
                params: {
                    begin: this.currentPage,
                    size: this.pageSize
                }
